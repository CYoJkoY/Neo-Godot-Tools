...
* [Fix reference location type syntax](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/10)
* [**Add completion query engine**](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/11)
* [Migrate completion provider to query engine](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/12)
* [Make semantic invalidation API-aware](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/13)
* [Add local query result cache](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/14)
* [Classify semantic changes for precise invalidation](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/15)
* [Improve semantic index invalidation](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/16)
* [Refresh dependency topology incrementally](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/17)
* [Key local query caches by snapshot identity](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/18)
* [Track query dependency snapshots](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/19)
* [**Expand local GDScript type inference**](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/20)
* [Synchronize architecture and roadmap with implementation](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/21)
* [Expand local GDScript type inference](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/22)
* [Advance local-first semantic roadmap batch](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/23)
* [Advance range-aware semantic analysis stage](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/24)
* [Complete local semantic hardening stage](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/25)
* [Harden local semantic production path](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/26)
* [Complete roadmap evidence and compatibility batch](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/27)
* [**Improve GDScript builtin function intelligence**](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/28)
* [Fix Ctrl+Click definition requests stalling](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/29)
* [Fix duplicate GDScript language feature results](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/30)
* [Fix navigation from builtin GDScript classes to documentation](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/31)
* [Fix builtin symbol definition navigation](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/32)
* [Preserve README structure while updating current features](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/33)
* [Prepare package.json for VS Code Marketplace](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/34)
* [Rename all Neo Godot Tools commands](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/35)
* [Rename Godot Tools namespace to Neo Godot Tools](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/36)
* [Prepare Neo Godot Tools for Marketplace release](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/37)
* [Complete Neo Godot Tools namespace migration](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/38)
* [Fix navigation from built-in functions to documentation](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/39)
* [Unify release and Marketplace publishing pipeline](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/40)
* [Migrate complete VS Code namespace](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/41)
* [Checkout repository before creating GitHub release](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/42)
* [Fix inherited scene node types and builtin definitions](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/43)
* [Fix inherited methods and scene instance types](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/44)
* [Fix nested scene resources and node drop paths](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/45)
* [Fix navigation for built-in GDScript methods](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/46)
* [Fix quoted script inheritance for definition navigation](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/47)
* [Fix scene node drops, types, and builtin definitions](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/48)
* [Fix scene node type and builtin definition resolution](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/49)
* [Fix Scene Preview script opening](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/50)
* [Fix recursive effective scene node type resolution](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/51)
* [Fix unified builtin symbol resolution](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/52)
* [Fix inherited method definitions through the full hierarchy](https://github.com/CYoJkoY/Neo-Godot-Tools/pull/53)
